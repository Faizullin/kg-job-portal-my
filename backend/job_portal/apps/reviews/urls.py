...
from .api.views import (
    ...
    OrderReviewsApiView, ReviewAnalyticsApiView, OrderAssignmentReviewsApiView
)
...
urlpatterns = [
    ...
    path('api/v1/reviews/assignments/', OrderAssignmentReviewsApiView.as_view(), name='assignment-reviews'),
]

...
from .serializers import (
    ...
    ReviewAnalyticsSerializer, OrderAssignmentReviewSerializer
)
...
class OrderAssignmentReviewsApiView(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        from job_portal.apps.jobs.models import OrderAssignment

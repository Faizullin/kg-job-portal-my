...
class PaymentMethodSerializer(AbstractTimestampedModelSerializer, AbstractChoiceFieldSerializerMixin):
    ...
    class Meta:
        model = PaymentMethod
        fields = [
            'id', 'user', 'method_type', 'method_type_display', 'card_last4',
            'card_brand', 'card_exp_month', 'card_exp_year', 'is_default', 'is_active'
        ]
...
class InvoiceSerializer(AbstractTimestampedModelSerializer, AbstractChoiceFieldSerializerMixin):
    ...
    class Meta:
        ...
        fields = [
            ...
            'subtotal', 'platform_fee', 'total_amount',
...
class PaymentSerializer(AbstractTimestampedModelSerializer, AbstractChoiceFieldSerializerMixin):
    ...
    class Meta:
        model = Payment
        fields = [
            'id', 'invoice', 'amount', 'currency', 'status', 'status_display',
...
class PaymentMethodCreateSerializer(AbstractTimestampedModelSerializer):
    class Meta:
        model = PaymentMethod
        fields = ['method_type', 'card_last4', 'card_brand', 'card_exp_month', 'card_exp_year']
...
class StripeWebhookEventSerializer(AbstractTimestampedModelSerializer):
    class Meta:
        ...
        fields = [
            'id', 'stripe_event_id', 'event_type', 'event_data',

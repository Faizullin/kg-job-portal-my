...
from .api.views_enhanced import (
    ProviderStatisticsApiView,
    ProviderDetailEnhancedApiView,
    RecommendationsApiView,
    DashboardStatisticsApiView,
    ServiceProviderSearchEnhancedApiView,
)
...
urlpatterns = [
    ...
    path('api/v1/users/providers/search/', ServiceProviderSearchEnhancedApiView.as_view(), name='service-providers-search-enhanced'),
    path('api/v1/users/providers/<int:pk>/enhanced/', ProviderDetailEnhancedApiView.as_view(), name='service-provider-enhanced'),
    path('api/v1/users/providers/statistics/', ProviderStatisticsApiView.as_view(), name='provider-statistics'),
    ...
    path('api/v1/users/recommendations/', RecommendationsApiView.as_view(), name='recommendations'),
    path('api/v1/users/dashboard/', DashboardStatisticsApiView.as_view(), name='dashboard-statistics'),
]

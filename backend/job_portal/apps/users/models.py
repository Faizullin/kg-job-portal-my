...
class ServiceProviderProfile(AbstractSoftDeleteModel, AbstractTimestampedModel):
    ...
    services_offered = models.ManyToManyField('core.ServiceSubcategory', blank=True, related_name='providers_offering_service')
...
class ClientProfile(AbstractSoftDeleteModel, AbstractTimestampedModel):
    ...
    # Client preferences
    preferred_services = models.ManyToManyField('core.ServiceSubcategory', blank=True, related_name='client_preferences')

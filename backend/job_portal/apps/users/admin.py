...
class MasterAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Basic Information", {"fields": ("user", "profession")}),
        (
            "Business Details",
            {
                "fields": (
        ...
        ("Verification", {"fields": ("is_verified_provider", "is_top_master")}),
    )
...
class EmployerAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Client Information", {"fields": ("user",)}),
        ("Preferences", {"fields": ("preferred_services",)}),
        (
            "Order History",
            {"fields": ("total_orders", "completed_orders", "cancelled_orders")},
        ),
        ("Favorites", {"fields": ("favorite_masters",)}),
    )
...
class MasterStatisticsAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Master Information", {"fields": ("master",)}),
        (
            "Performance Metrics",
            {
                "fields": (
        ...
        ("Ratings & Reviews", {"fields": ("average_rating", "total_reviews")}),
        (
            "Timestamps",
...
class MasterSkillAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Master & Skill", {"fields": ("master", "skill")}),
        (
            "Proficiency Details",
            {
                "fields": (
...
class PortfolioItemAdmin(admin.ModelAdmin):
    ...
    def get_queryset(self, request):
        return (
            super().get_queryset(request).select_related("master__user", "skill_used")
        )
...
class CompanyAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Company Information", {"fields": ("name", "description", "website")}),
        (
            "Contact Information",

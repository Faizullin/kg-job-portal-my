...
class AbstractIsOwnerOrAdmin(permissions.BasePermission):
    """
...
class HasClientProfile(permissions.BasePermission):
    ...
    def has_permission(self, request, view):
        ...
        try:
            return hasattr(request.user, 'job_portal_profile') and hasattr(request.user.job_portal_profile, 'client_profile')
        except:
            return False
...
class HasServiceProviderProfile(permissions.BasePermission):
    ...
    def has_permission(self, request, view):
        ...
        try:
            return hasattr(request.user, 'job_portal_profile') and hasattr(request.user.job_portal_profile, 'service_provider_profile')
        except:
            return False

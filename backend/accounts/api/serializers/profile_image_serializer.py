...
from utils.serializers import AbstractFileUploadSerializerMixin


class ProfileImageUploadSerializer(AbstractFileUploadSerializerMixin, serializers.ModelSerializer):
